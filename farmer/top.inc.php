         ...
         <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="farm.php" > Farm Manager</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
                     <a href="hire.php" > Equipment</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
                     <a href="index.php" > Farm Guide</a>
                  </li>
				  ...
				  <?php if($_SESSION['ADMIN_ROLE']!=1){?>
				   ...
				   <li class="menu-item-has-children dropdown">
                     <a href="vendor_management.php" > Manage Farmer</a>
                  </li>
				  <li class="menu-item-has-children dropdown">
                     <a href="categories.php" > Categories Master</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
                     <a href="vendor_management.php" > Farmers Manager</a>
                  </li>
				  <li class="menu-item-has-children dropdown">
				  ...
				  <li class="menu-item-has-children dropdown">
                     <a href="users.php" > Manager Buyer </a>
                  </li>
				  <li class="menu-item-has-children dropdown">
         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="../index.php">FarmUg Admin</a>
                  <a class="navbar-brand hidden" href="index.php"><img src="imagSes/logo2.png" alt="Logo"></a>
