                            ...
                            <div class="accordion-list">
                                <div class="accordion">
									...
									<form method="post">
										<div class="accordion__body">
											<div class="bilinfo">
													...
													<div class="row">
														...
														<div class="col-md-6">
															<div class="single-input">
																<input type="text" name="pincode" placeholder="Phone/ Tel" required>
															</div>
														</div>
										...
										<div class="accordion__body">
											<div class="paymentinfo">
												<div class="single-method">
													VIA MOBILE MONEY <br>
													<input type="radio" name="payment_type" value="MTN Momo" required/> MTN MOMO <br>
													<input type="radio" name="payment_type" value="Airtel money" required/> AIRTEL MONEY <br>
													VIA BANK <br>
													<input type="radio" name="payment_type" value="UBA Uganda" required/> UBA BAN UG 
												</div>
												<div class="single-method">
										...
										<div>
								<p>
									<button class="btn btn-lg btn-primary" type="button" data-toggle="collapse" data-target="#contentId" aria-expanded="false"
								...
								<div class="collapse" id="contentId">
									<div class="jumbotron jumbotron-fluid">
										...
										<div class="list-group">
											<button type="button" class="list-group-item list-group-item-action active">Mag20</button>
											<button type="button" class="list-group-item list-group-item-action">Elias453</button>
											<button type="button" class="list-group-item list-group-item-action ">Free101</button>
										</div>
